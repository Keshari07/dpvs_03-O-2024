...
Major features of `KB` including:
...
`KB` feature modules are illustrated as following picture.
...
```bash
$ git clone https://github.com/Keshari07/dpvs_03-O-2024.git
$ cd dpvs_03-O-2024
```
...
* github: `https://github.com/Keshari07/dpvs_03-O-2024.git`
